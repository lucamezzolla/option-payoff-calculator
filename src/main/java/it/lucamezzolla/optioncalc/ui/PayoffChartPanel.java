...
public final class PayoffChartPanel extends JPanel {
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        try {
            ...
            if (scenarios.size() < 2) {
                ...
                g2.drawString(I18n.text("chart.empty"), left + 20, top + 30);
                return;
            }
            ...
            String minXText = formatNumber(minX, 4) + " €";
            String maxXText = formatNumber(maxX, 4) + " €";
            String minYText = formatNumber(minY, 2) + " €";
            String maxYText = formatNumber(maxY, 2) + " €";
            ...
            String title = I18n.text("chart.title");
    ...
    private static String formatNumber(BigDecimal value, int fractionDigits) {
